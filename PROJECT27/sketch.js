...
function setup() {
	...
	bob1Object = new Bob(110,450,80,80);
	
	bob3object = new Bob(190,450,80,80);
	bob2object = new Bob(270,450,80,80);
	bob4object = new Bob(350,450,80,80);
	bob5object = new Bob(430,450,80,80);
...
function keyPressed(){
	if(keyCode === UP_ARROW){
	  Matter.Body.applyForce(bob1Object.body,bob1Object.body.position,{x:-600,y:600});
